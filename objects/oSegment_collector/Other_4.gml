if(room == segment_rooms[segment]) {
	...
	if(room = rSegment_fill) global.fill_segment = data;
		...
		if(oSegment_data.level_three) portal_index = 3;
		global.portal_segment[portal_index] = data;
	}
	else if(oSegment_data.shop) {
		var shop_index = 0;
		if(oSegment_data.level_one) shop_index = 1;
		if(oSegment_data.level_two) shop_index = 2;
		if(oSegment_data.level_three) shop_index = 3;
		global.shop_segment[shop_index] = data;
